...
create type source_type as enum ('male', 'female', 'npc-trade', 'side-game', 'regional', 'special', 'shiny', 'wild', 'original', 'mega', 'gmax', 'battle-only', 'variant', 'hatch', 'starter', 'evolved', 'prize', 'gift', 'pokewalker', 'fossil');
